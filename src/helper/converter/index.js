export const wordingRupiah = (nominal) => {
  ...
  const _nominalWording = (nominal) => {
    ...
    if (nominal < ONE_HUNDRED) {
      if (nominal < UNIQUE_TWELVE) return UNIQUE_NAMING[nominal];
      if (nominal < UNIQUE_TWENTY)
        return _nominalWording(nominal % TEN) + "Belas ";
      return (
        _nominalWording(Math.floor(nominal / TEN)) +
        "Puluh " +
        _nominalWording(nominal % TEN)
      );
    }
    if (nominal < ONE_THOUSAND) {
      ...
      return (
        _nominalWording(Math.floor(nominal / ONE_HUNDRED)) +
        "Ratus " +
        _nominalWording(nominal % ONE_HUNDRED)
      );
    }
    if (nominal < ONE_MILLION) {
      ...
      return (
        _nominalWording(Math.floor(nominal / ONE_THOUSAND)) +
        "Ribu " +
        _nominalWording(nominal % ONE_THOUSAND)
      );
    }
    if (nominal < ONE_BILLION)
      return (
        _nominalWording(Math.floor(nominal / ONE_MILLION)) +
        "Juta " +
        _nominalWording(nominal % ONE_MILLION)
      );
    return (
      _nominalWording(Math.floor(nominal / ONE_BILLION)) +
      "Miliar " +
      _nominalWording(nominal % ONE_BILLION)
    );
  };
